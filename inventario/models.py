...
class ingresoFacturas(models.Model):
    ...
    precio_in = models.DecimalField(max_digits=8, decimal_places=2)
    ...
    precio_factura = models.DecimalField(max_digits=8, decimal_places=2)
...
class cierreInventario(models.Model):
    idcodigo = models.ForeignKey(codigo_prod, on_delete=models.CASCADE)
    idEstatusUso = models.ForeignKey(nuevo_usado, on_delete=models.CASCADE)
    ingreso_proveedores = models.DecimalField(max_digits=6, decimal_places=2)
    ingreso_retiros = models.DecimalField(max_digits=6, decimal_places=2)
    salida_instalaciones = models.DecimalField(max_digits=6, decimal_places=2)
    salida_ventaContado = models.DecimalField(max_digits=6, decimal_places=2)
    salida_ventaCredito = models.DecimalField(max_digits=6, decimal_places=2)
    salida_dañados = models.DecimalField(max_digits=6, decimal_places=2)
    idBodega = models.ForeignKey(bodega, on_delete=models.CASCADE)
    id_empresa = models.ForeignKey(empresa, on_delete=models.CASCADE, default=1)
    digitador = models.ForeignKey(User, on_delete=models.CASCADE)
    fecha = models.DateField()
    movimientos_entrada = models.DecimalField(max_digits=6, decimal_places=2)
    movimientos_salida = models.DecimalField(max_digits=6, decimal_places=2)
